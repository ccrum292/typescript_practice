...
class Matrix {
    constructor(givenString) {
        this.formColumns = (givenString) => {
            ...
            return columnsArray;
            // return rowsArray.map((val, firstIndex) => {
            //   return rowsArray.map((characterArray, secondIndex) => {
            //     return characterArray[firstIndex]
            //   })
            // })
        };
        this.formRows = (givenString) => {
